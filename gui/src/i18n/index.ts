...
i18n
  ...
  .init({
    resources: {
      en: {
        translation: {
          app: { name: 'envSwitch', version: 'v0.2.3' },
          ...
          doctor: { subtitle: 'Diagnose setup issues', runningChecks: 'Running checks...', allOk: 'All systems OK', checksPassed: 'checks passed', issuesFound: 'issues found', warnings: 'warnings', platformDetected: 'Platform detected', modulesLoaded: 'Modules loaded', shimsDir: 'Shims directory', brewAvailable: 'Homebrew available', brewFound: 'brew found', brewNotFound: 'brew not found', countModules: 'modules', cliAvailable: 'envSwitch CLI available', cliOptional: 'optional — for terminal use', shellInit: 'Shell integration initialized', shellNotInit: 'not initialized — run: envswitch init', initCheckHint: 'Shell integration required for cover/uncover to work' },
          settings: { title: 'Settings', subtitle: 'Configure envSwitch behavior', shellIntegration: 'Shell Integration', shellDesc: 'Set up shell hooks so cover takes effect (adds shims to PATH, auto-sources env.sh)', status: 'Status', notInit: 'Not initialized', initBtn: 'Initialize', uninitBtn: 'Remove', language: 'Language', languageDesc: 'Switch between English and Chinese', proxy: 'Proxy', proxyDesc: 'HTTP/HTTPS proxy for downloads', brewSource: 'Homebrew Source', brewSourceDesc: 'Custom Homebrew registry mirror', cliExamples: 'CLI Examples', saved: 'Saved', proxySaved: 'Proxy saved — takes effect on next install', copied: 'Copied', switchedEn: 'Switched to English', switchedZh: '已切换为中文' },
          toast: { covered: 'covered', uncovered: 'uncovered', started: 'started', stopped: 'stopped', error: 'Error' },
          logs: { empty: 'No operations yet — logs will appear here as you use envSwitch', operationLog: 'Operation Log', subtitle: 'All operations — install, cover, service, errors', entries: 'entries', clear: 'Clear', clearConfirm: 'Clear all operation logs?' },
      ...
      zh: {
        translation: {
          ...
          doctor: { subtitle: '诊断配置问题', runningChecks: '检查中...', allOk: '所有系统正常', checksPassed: '项通过', issuesFound: '个问题', warnings: '个警告', platformDetected: '平台检测', modulesLoaded: '模块加载', shimsDir: 'Shims 目录', brewAvailable: 'Homebrew 可用', brewFound: '已发现 brew', brewNotFound: '未找到 brew', countModules: '个模块', cliAvailable: 'envSwitch 命令行可用', cliOptional: '可选 — 终端使用', shellInit: 'Shell 集成已初始化', shellNotInit: '未初始化 — 运行: envswitch init', initCheckHint: 'Shell 集成是 cover/uncover 正常工作的前提' },
          settings: { title: '设置', subtitle: '配置 envSwitch 行为', shellIntegration: 'Shell 集成', shellDesc: '设置 Shell 钩子使 cover 生效（将 shims 加入 PATH，自动 source env.sh）', status: '状态', notInit: '未初始化', initBtn: '初始化', uninitBtn: '移除', language: '语言', languageDesc: '切换中文和英文界面', proxy: '代理', proxyDesc: '下载使用的 HTTP/HTTPS 代理', brewSource: 'Homebrew 源', brewSourceDesc: '自定义 Homebrew 镜像源', cliExamples: 'CLI 示例', saved: '已保存', proxySaved: '代理已保存 — 下次安装时生效', copied: '已复制', switchedEn: 'Switched to English', switchedZh: '已切换为中文' },
          toast: { covered: '已覆盖', uncovered: '已取消覆盖', started: '已启动', stopped: '已停止', error: '错误' },
          logs: { empty: '暂无操作 — 使用 envSwitch 后日志将显示在此处', operationLog: '操作日志', subtitle: '所有操作 — 安装、覆盖、服务、错误', entries: '条', clear: '清空', clearConfirm: '确认清空所有操作日志？' },
